    ...
    <main className="min-h-[85vh] flex flex-col items-center justify-center px-6 py-16">
      <div className="text-center max-w-2xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 max-w-xl mx-auto">
          <a
            href="/browse"
            className="bg-gold text-navy rounded-2xl p-8 text-left hover:bg-yellow-300 transition-all group min-h-[280px]"
          >
            <div className="flex flex-col justify-between h-full">
              <div>
                ...
                <div className="text-navy/60 text-sm leading-relaxed">
                  266 event types with tasks already built. Pick yours and go.
                </div>
              </div>
          ...
          <a
            href="/custom"
            className="bg-white border-2 border-navy text-navy rounded-2xl p-8 text-left hover:bg-navy/5 transition-all group min-h-[280px]"
          >
            <div className="flex flex-col justify-between h-full">
              <div>
                <div className="text-4xl mb-5">✨</div>
                ...
                <div className="text-navy/60 text-sm leading-relaxed">
                  Describe any event — Dengine decomposes it into claimable tasks instantly.
                </div>
              </div>
