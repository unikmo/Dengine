...
export default async function AdminPage(){
  ...
  return <main className="min-h-screen bg-[#f5f2ea]"><section className="shell py-10 sm:py-14">
    <div className="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between"><div><p className="eyebrow">RunYourEvent operations</p><h1 className="display mt-3 text-4xl font-black sm:text-5xl">Admin dashboard</h1><p className="mt-3 text-sm text-[#687386]">Demand, revenue, workspace activity and segment performance in one place.</p></div><form action="/api/admin/logout" method="post"><button className="btn-secondary" type="submit">Sign out</button></form></div>
